...
{
    public class OpenPropertyDialogViewModel : BindableBase, IDialogAware
    {
        #region 变量
        private readonly IParameterService _parameterService;
        #endregion
        #region 属性绑定
        public string Title => "开路测试属性设置";
        ...
        #endregion
        #region 构造函数
        public OpenPropertyDialogViewModel(IParameterService parameterService)
        {
