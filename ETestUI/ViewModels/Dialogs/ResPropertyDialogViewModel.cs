...
{
    public class ResPropertyDialogViewModel : BindableBase, IDialogAware
    {
        ...
        #endregion
        #region 构造函数
        public ResPropertyDialogViewModel(IParameterService parameterService)
        {
