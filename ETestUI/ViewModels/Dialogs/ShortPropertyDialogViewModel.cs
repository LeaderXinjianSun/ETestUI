...
{
    public class ShortPropertyDialogViewModel : BindableBase, IDialogAware
    {
        #region 变量
        private readonly IParameterService _parameterService;
        #endregion
        #region 属性绑定
        public string Title => "短路测试属性设置";
        ...
        #endregion
        #region 构造函数
        public ShortPropertyDialogViewModel(IParameterService parameterService)
        {
